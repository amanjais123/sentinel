...
import { LayoutDashboard, History as HistoryIcon, ShieldCheck, X } from 'lucide-react';
...
export function Sidebar({ isMobileMenuOpen, setIsMobileMenuOpen }) {
    ...
    return (
        <>
            ...
            <aside className={cn(
                "w-64 bg-white border-r border-brand-100 flex flex-col fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 md:relative md:translate-x-0 md:flex",
                ...
                <div className="p-6 flex items-center justify-between gap-3">
                    ...
                    {setIsMobileMenuOpen && (
                        <button className="md:hidden p-1 hover:bg-brand-50 rounded-md" onClick={() => setIsMobileMenuOpen(false)}>
